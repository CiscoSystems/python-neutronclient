...
class CLITestV20HostingDevice(test_cli20.CLITestV20Base):
    def test_create_hosting_device(self):
        ...
        cmd = hostingdevice.CreateHostingDevice(test_cli20.MyApp(sys.stdout),
                                                None)
        name = 'Device 1'
        template = 'Template 1'
        myid = 'myid'
    ...
    def test_list_hosting_devices_detail(self):
        ...
        cmd = hostingdevice.ListHostingDevice(test_cli20.MyApp(sys.stdout),
                                              None)
        response_contents = [{
    ...
    def test_update_hosting_device_exception(self):
        ...
        resource = 'hosting_device'
        cmd = hostingdevice.UpdateHostingDevice(test_cli20.MyApp(sys.stdout),
                                                None)
    ...
    def test_delete_hosting_device(self):
        ...
        resource = 'hosting_device'
        cmd = hostingdevice.DeleteHostingDevice(test_cli20.MyApp(sys.stdout),
                                                None)
        myid = 'myid'
        args = [myid]
    ...
    def test_show_hosting_device(self):
        ...
        resource = 'hosting_device'
        cmd = hostingdevice.ShowHostingDevice(test_cli20.MyApp(sys.stdout),
                                              None)
