...
class CLITestV20HostingDeviceTemplate(test_cli20_cisco.CLITestV20BaseCisco):
    def test_create_hosting_device_template(self):
        """Create hosting device template."""
        resource = 'hosting_device_template'
        cmd = hostingdevicetemplate.CreateHostingDeviceTemplate(
    ...
    def test_list_hosting_device_templates_detail(self):
        ...
        cmd = hostingdevicetemplate.ListHostingDeviceTemplate(
            test_cli20.MyApp(sys.stdout), None)
        response_contents = [{
    ...
    def _test_update_hosting_device_template(
            ...
            tenantbound=None):
        resource = 'hosting_device_template'
        cmd = hostingdevicetemplate.UpdateHostingDeviceTemplate(
            test_cli20.MyApp(sys.stdout), None)
        myid = 'myid'
        args = [myid]
        expected = {}
    ...
    def test_delete_hosting_device_template(self):
        ...
        resource = 'hosting_device_template'
        cmd = hostingdevicetemplate.DeleteHostingDeviceTemplate(
            test_cli20.MyApp(sys.stdout), None)
        myid = 'myid'
        args = [myid]
    ...
    def test_show_hosting_device_template(self):
        ...
        resource = 'hosting_device_template'
        cmd = hostingdevicetemplate.ShowHostingDeviceTemplate(
            test_cli20.MyApp(sys.stdout), None)
