...
from neutronclient.tests.unit.cisco import test_cli20_cisco
from neutronclient.tests.unit import test_cli20


class CLITestV20RouterType(test_cli20_cisco.CLITestV20BaseCisco):
    def test_create_router_type(self):
        """Create router type."""
        resource = 'routertype'
        cmd = routertype.CreateRouterType(test_cli20.MyApp(sys.stdout), None)
        template = 'Template 1'
    ...
    def test_list_router_types_detail(self):
        ...
        cmd = routertype.ListRouterType(test_cli20.MyApp(sys.stdout), None)
        response_contents = [{
    ...
    def test_update_router_type_exception(self):
        ...
        resource = 'routertype'
        cmd = routertype.UpdateRouterType(test_cli20.MyApp(sys.stdout), None)
    ...
    def test_delete_router_type(self):
        ...
        resource = 'routertype'
        cmd = routertype.DeleteRouterType(test_cli20.MyApp(sys.stdout), None)
        myid = 'myid'
        args = [myid]
    ...
    def test_show_router_type(self):
        ...
        resource = 'routertype'
        cmd = routertype.ShowRouterType(test_cli20.MyApp(sys.stdout), None)
