...
class ListHostingDevice(HostingDevice, neutronV20.ListCommand):
...
class ShowHostingDevice(HostingDevice, neutronV20.ShowCommand):
    """Show information of a given hosting device."""


class CreateHostingDevice(HostingDevice, neutronV20.CreateCommand):
...
class DeleteHostingDevice(HostingDevice, neutronV20.DeleteCommand):
    """Delete a given hosting device."""


class UpdateHostingDevice(HostingDevice, neutronV20.UpdateCommand):
