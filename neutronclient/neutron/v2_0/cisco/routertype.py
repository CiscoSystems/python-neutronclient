...
class ListRouterType(RouterType, neutronV20.ListCommand):
...
class ShowRouterType(RouterType, neutronV20.ShowCommand):
    """Show information of a given router type."""


class CreateRouterType(RouterType, neutronV20.CreateCommand):
...
class DeleteRouterType(RouterType, neutronV20.DeleteCommand):
    """Delete a given router type."""


class UpdateRouterType(RouterType, neutronV20.UpdateCommand):
