...
class HostingDeviceTemplate(object):
    resource = TEMPLATE
...
class ListHostingDeviceTemplate(HostingDeviceTemplate, neutronV20.ListCommand):
...
class ShowHostingDeviceTemplate(HostingDeviceTemplate, neutronV20.ShowCommand):
    """Show information of a given hosting device template."""


class CreateHostingDeviceTemplate(HostingDeviceTemplate,
...
class DeleteHostingDeviceTemplate(HostingDeviceTemplate,
                                  neutronV20.DeleteCommand):
    """Delete a given hosting device template."""


class UpdateHostingDeviceTemplate(HostingDeviceTemplate,
